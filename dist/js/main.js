...
function closeFilter() {
    ...
    for (i = 0; i < x.length; i++) {
        ...
        var card_element = '<div class="result-container"> <img src="images/baseline-more_vert-24px.svg"  alt="' + x[i].TaskName + '" id="mob-menu"  onclick="showMenu(this)"> <div class="menu-s" id="' + x[i].TaskName + '"><img src="images/outline-close-24px.svg" id="close-mob"  alt="' + x[i].TaskName + '" onclick="closeMenuMob(this)" ><div class="icons-item-m"> <img id="completed-m" alt="' + x[i].TaskName + '" class="sIcon" onclick="colorCompleted(this)" style="filter:grayscale(' + com + ')" src="images/outline-done-24px.svg"> <img id="priority-m" class="sIcon" alt="' + x[i].TaskName + '" onclick="colorImportant(this)" style="filter:grayscale(' + imp + ')" src="images/outline-star_border-24px (1).svg"> <img id="archive-m" class="sIcon" alt="' + x[i].TaskName + '" onclick="colorArchived(this)" style="filter:grayscale(' + arc + ')" src="images/outline-archive-24px.svg"> </div></div><div class="title-item"> <div class="task-color" style="background-color:' + x[i].TaskColor + '"></div> <h3>' + x[i].TaskName + '</h3> <p id="t-desc">' + x[i].TaskDec + '</p> </div> <div class="date-item"> <p>Due Date:' + x[i].DueDate + '</p> </div> <div class="icons-item" > <img id="completed" alt="' + x[i].TaskName + '" class="sIcon" onclick="colorCompleted(this)" style="filter:grayscale(' + com + ')" src="images/outline-done-24px.svg"> <img id="priority" class="sIcon" alt="' + x[i].TaskName + '" onclick="colorImportant(this)" style="filter:grayscale(' + imp + ')" src="images/outline-star_border-24px (1).svg"> <img id="archive" class="sIcon" alt="' + x[i].TaskName + '" onclick="colorArchived(this)" style="filter:grayscale(' + arc + ')" src="images/outline-archive-24px.svg"> </div> <div id="sep-mob"></div> </div>'
...
function createTask(tName, tDesc, tTags, tDDate, tADate, tColor) {
    var card_element = '<div class="result-container"> <img src=" images/baseline-more_vert-24px.svg" id="mob-menu" onclick="showMenu(this)"> <div class="menu-s"></div> <div class="title-item"> <div class="task-color" style="background-color:' + tColor + '"></div> <h3>' + tName + '</h3> <p id="t-desc">' + tDesc + '</p> </div> <div class="date-item"> <p>Due Date:' + tDDate + '</p> </div> <div class="icons-item"> <img id="completed" class="sIcon" alt="' + tName + '" onclick="colorCompleted(this)" src=" images/outline-done-24px.svg" alt="complete"> <img id="priority" onclick="colorImportant(this)" alt="' + tName + '" class="sIcon" src=" images/outline-star_border-24px (1).svg"> <img id="archive" class="sIcon" alt="' + tName + '" onclick="colorArchived(this)" src=" images/outline-archive-24px.svg"> </div> </div>'
    $("#search-re").append(card_element);
}
...
$(document).ready(function createCard() {
    ...
    for (i = (x.length - 1); i > (x.length - 4); i--) {
        ...
        var card = ' <div class="task-body__card--preview"> <div id="tag-color" style="background-color:' + x[i].TaskColor + '"></div> <h5>' + x[i].TaskName + '</h5> <div id="sep"></div> <p>' + x[i].TaskDec + '</p> <div class="date-c"> <img src=" images/outline-calendar_today-24px.svg" id="card-calendar"> <p id="due-date">' + x[i].DueDate + '</p> </div> <div class="icons"> <img src=" images/outline-done-24px.svg" alt="' + x[i].TaskName + '" id="completed" onclick="colorCompleted(this)" style="filter:grayscale(' + com + ')"> <img src=" images/outline-star_border-24px (1).svg" alt="' + x[i].TaskName + '" id="priority" onclick="colorImportant(this)" style="filter:grayscale(' + imp + ')"> <img src=" images/outline-archive-24px.svg" alt="' + x[i].TaskName + '" id="archive" onclick="colorArchived(this)" style="filter:grayscale(' + arc + ')"> </div> </div>'
